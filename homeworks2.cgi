...
elif not is_int(stuid) and stuid !="":
  print("""<div id="alert" class="alert alert-danger" role="alert"> You must submit an student id number.</div>""")
